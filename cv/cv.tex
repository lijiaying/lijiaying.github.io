...
\textsc{Sep.} 2011 - \textsc{Jun.} 2013& Study in \textsc{Institute of Computing Technology} \\
...
\begin{itemize}
	...
	\item Design a heuristic algorithm to search for a good program partitioning which would lead to a disjunctive loop-invariant with fewer clauses by exploring the structure of the loop adaptively.
...
\begin{itemize}
	...
	\item Form conjectures on the constraint based on sampling and classification techniques; 
...
\begin{tabular}{rl}	
	\textsc{Jul.} 2013 - \textsc{Sep.} 2013  & Research assistant in ISTD, SUTD, Singapore \\
	\textsc{Dec.} 2012 - \textsc{Jun.} 2013	 & Research assistant in acs, ICT, CAS, Beijing, China \\
	\textsc{Mar.} 2012 - \textsc{Nov.} 2012  & Research assistant in bwlab, ICT, CAS, Beijing, China \\
